...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .plan-icon { font-size: 3.2rem; margin-bottom: 12px; }
        .plan-card h2 { font-size: 1.5rem; font-weight: 600; margin-bottom: 8px; color: #fff; }
        .plan-card .desc {
            font-size: 0.95rem;
            color: #b0c0d5;
            line-height: 1.5;
        ...
        .modal h2 { font-size: 1.8rem; margin-bottom: 8px; color: #fff; }
        .modal .sub { color: #8a9bb5; margin-bottom: 24px; font-size: 1rem; }
        ...
        .modal .option-btn .emoji { font-size: 1.6rem; }
        .modal .close-modal {
            position: absolute;
            top: 16px;
            right: 22px;
        ...
        .modal .close-modal:hover { color: #fc4a1a; }
        .footer {
            margin-top: 50px;
            text-align: center;
            color: #4a5a75;
        ...
        @media (max-width: 480px) {
            ...
            .plan-card { padding: 22px 16px 24px; }
